    ...
    <div class="section-header">
      ...
      <h1>Profile</h1>
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active">Profile Peusahaan</div>
          </div>
    </div>
      ...
      <div class="section-body">
        ...
        <div class="card">
          ...
          @endif
              <form action="{{ url('/perusahaan/update/' . $perusahaan->id) }}">
                @csrf
            {{-- <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Detail</label>
                    <input type="text" class="form-control" name="detail" value="{{ $perusahaan->detail }}">
                  </div>
                  <div class="form-group">
                    <label>History</label>
                    <input type="text" class="form-control" name="history" value="{{ $perusahaan->history }}">
                  </div>
            </div> --}}
            <div class="section-body">
